  ...
  return (
    <Box>
      <SEO
        ...
        description={`${data.tagline} Configural automates scheduling, referrals, and care management for ${data.specialty.toLowerCase()} practices.`}
      ...
      <SectionWrapper
        ...
        title="What Configural Automates"
      ...
      <SectionWrapper
        ...
        title="Discover How Configural Works"
      ...
      >
        <Grid container spacing={3}>
          {[
            ...
            { label: 'Explore the Platform', desc: 'Understand the architecture, integrations, and security behind Configural.', to: '/platform' },
        ...
        <Container maxWidth="md" sx={{ textAlign: 'center' }}>
          ...
          >
            ...
            <Typography variant="body1" sx={{ color: 'rgba(248,250,251,0.8)', mb: 4, maxWidth: 550, mx: 'auto' }}>
              See how Configural's AI employees can automate your most time-consuming workflows and unlock new revenue.
            </Typography>
